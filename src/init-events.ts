...
import { FD_EVENTS_ACCESSIBILITY_ANNOUCEMENT_FINISHED, FD_EVENTS_ACCESSIBILITY_CHANGE, FD_EVENTS_BACK_PRESS, FD_EVENTS_DID_BLUR, FD_EVENTS_DID_FOCUS, FD_EVENTS_KEYBOARD_DID_CHANGEFRAME, FD_EVENTS_KEYBOARD_DID_HIDE, FD_EVENTS_KEYBOARD_DID_SHOW, FD_EVENTS_KEYBOARD_WILL_CHANGEFRAME, FD_EVENTS_KEYBOARD_WILL_HIDE, FD_EVENTS_KEYBOARD_WILL_SHOW, FD_EVENTS_STATUS_CHANGE, FD_EVENTS_WILL_BLUR, FD_EVENTS_WILL_FOCUS } from './interfaces';
...
export function add_state_listener(fire_msg: FireMessage) {
	function listener(state: AppStateStatus) {
		fire_msg(FD_EVENTS_STATUS_CHANGE, state);
	}
...
export function add_accesibility_listener(fire_msg: FireMessage) {
	function listener1(event: AccessibilityChangeEvent) {
		fire_msg(FD_EVENTS_ACCESSIBILITY_CHANGE, event);
		return true;
	}
	function listener2(event: AccessibilityAnnoucementFinishedEvent) {
		fire_msg(FD_EVENTS_ACCESSIBILITY_ANNOUCEMENT_FINISHED, event);
		return true;
	}
...
// 		fire_msg(FD_EVENTS_NET_CHANGE, event);
// 	};
// 	if (NetInfo) {
