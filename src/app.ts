...
export default function container(type: 'stack' | 'drawer' | 'bottom-tab' | 'material-bottom-tab' | 'material-top-tab', actions: IActions, events: IEvents, config: AppConfig, css: string, ...pages: Page[]) {
